      ...
      <TrustSection title="本人に提案する文面">
        <NotificationSampleGrid>
          ...
          <MessageTemplate
            ...
            body="もし使うなら、通知が届いた時に誰がどう確認するかを先に決めておきたいです。あんぴッチは発見や所在確認を保証するものではなく、本人が24時間以上OKを押していない場合は本人へ、36時間以上続くと登録・同意済みの連絡先へ通知します。無理に始める必要はないので、内容を一緒に確認しましょう。"
      ...
      >
        <NotificationSampleGrid>
          ...
          <MessageTemplate
            ...
            recipient="本人から連絡先候補へ"
            body="もし通知が届いたら、ご無理のない範囲で、まず私に電話かメッセージをしてみてください。連絡が取れない場合に誰へ伝えるかは、事前に一緒に決めておきたいです。緊急の危険が明らかな場合は、電話など別の手段も使ってください。"
          ...
          <MessageTemplate
            ...
            recipient="本人から連絡先候補へ"
            body="あんぴッチは、反応が途切れた時に登録・同意済みの連絡先へ段階通知を試行するサービスです。危険や死亡を判断するものではなく、発見・所在確認を保証するものでもありません。"
