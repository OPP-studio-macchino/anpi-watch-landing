            ...
            <TrustSection title="あんぴッチから届く通知SMS">
                <NotificationSampleGrid>
                    ...
                    <NotificationSample
                        ...
                        sample="【あんぴッチ】最後のOKから30時間たちました。36時間で連絡先AへSMSを送ります。追加料金はありません。連絡先へ通知したくない場合は、今OKを押してください。"
                    ...
                    <NotificationSample
                        ...
                        target="連絡先B"
                        timing="最後のOKから42時間後"
                        purpose="別の連絡先にも、無理のない範囲で連絡を試してもらうため"
