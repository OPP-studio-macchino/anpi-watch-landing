...
const timeline = [
  ...
  { time: "36時間", label: "連絡先A", detail: "連絡先AへSMS送信を試行します。追加料金は発生しません。" },
  { time: "42時間", label: "連絡先B", detail: "連絡先BへSMS送信を試行します。追加料金は発生しません。" },
  { time: "48時間以上", label: "A/Bへ最後のSMS", detail: "連絡先A/Bへ最後のSMS送信を試行します。追加料金は発生しません。" }
];
...
const interfaceCards = [
  ...
  {
    title: "透明性を隠さない",
    body: "通知の記録と通知エピソード履歴を設定から確認できます。"
  }
];
...
const faqs = [
  ...
  {
    q: "連絡先通知で追加料金は発生しますか？",
    a: "いいえ。36h / 42h / 48h の連絡先通知は月額料金に含まれます。36hで連絡先AへSMS送信を試行しても、追加料金は発生しません。"
  }
];
        ...
        <div className="content">
          <div className="section-heading">
            ...
            <p>
              ...
              ただし、2人の同意、通知の順番、月額料金、できないことは隠しません。
            </p>
          </div>
