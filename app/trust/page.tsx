  ...
  return (
    ...
    >
      ...
      <TrustSection title="通知について知っておくこと">
        <TrustList
          items={[
            "ショートメッセージ、スマホ通知、メールは、電波の状態やスマホの設定によって、遅れたり届かなかったりすることがあります。",
            "配信成功と表示されても、相手が読んだことや対応したことまでは分かりません。",
      ...
      <TrustSection title="先に知っておいてほしいこと">
        <p>
          あんぴッチは、本人の反応が長くない時の連絡ルールを見えるようにするアプリです。できることと、できないことを先に知っておくことで、本人・家族・連絡先の方が同じ理解で使えます。
        </p>
      </TrustSection>
