...
Phase 2: Wedge Launch の開始前レビューに渡せる状態です。公開LP、料金、FAQ、Manual、Tutorial 周辺では、月額300円、36h以降の連絡先通知に追加料金なし、2名同意、URL同意、救命・発見・所在確認を保証しないことが主要導線で説明されています。
...
| ルート | 月額300円 | 36h以降の追加料金なし | 2名同意まで通知開始なし | URL同意標準 | 救命・発見・所在確認を保証しない | 通知到達・閲覧・連絡先行動を保証しない | 禁止販売コピー | CTAが理解導線を含む | Findings |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `/` | OK | OK | OK | OK | OK | Linked | OK | OK | トップで価格、追加料金なし、2名同意、できないことを説明。通知到達保証なしは `/before-you-start` や `/delivery-status` への理解導線で補強。 |
...
| `/trust` | OK | OK | OK | OK | OK | OK | OK | OK | できること・できないこと、deliveredの意味、到達・閲覧・対応を保証しないことが明確。 |
| `/delivery-status` | Linked | Linked | OK | OK | Linked | OK | OK | OK | 配信結果ページとして、deliveredを閲覧・対応と誤認させない説明がある。料金は関連導線で確認。 |
| `/manual` | OK | OK | OK | OK | OK | OK | OK | OK | Manualデータ内で月額300円、36h以降追加料金なし、2名URL同意、保証しない範囲を説明。 |
| `/manual/faq` | OK | OK | OK | OK | OK | OK | OK | OK | FAQデータ内で料金、追加請求なし、連絡先同意、危険検知・救命保証ではないことを説明。 |
...
- 36h / 42h / 48h の連絡先通知に追加料金なしと説明されている。
- 通知ごとの追加請求なしと説明されている。
...
- 通知到達保証に見えるコピーがある。
- 月額300円が不明確。
- 36h以降の連絡先通知に追加料金なしであることが不明確。
- 2名同意前に通知が稼働しているように見える。
- URL同意ではなく代理同意で進められるように見える。
- 連絡先に過度な責任を負わせる表現がある。
- delivered が閲覧や対応の確認に見える。
