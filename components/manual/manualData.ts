...
export const contactASteps = [
  ...
  { title: "電話帳から選ぶか、名前と電話番号を手で入力します。", outcome: "名前と電話番号が入ります。" },
  { title: "名前と電話番号を確認します。", outcome: "本人の電話番号ではないことを確認できます。" },
  { title: "内容に間違いがなければ保存します。", outcome: "連絡先A（1人目）が登録されます。" },
  { title: "アプリに表示されている案内に沿って同意依頼SMSを送ります。", outcome: "相手にSMS（ショートメッセージ）が届きます。" }
] as const;
...
export const contactBSteps = [
  ...
  { title: "内容に間違いがなければ保存します。", outcome: "連絡先B（2人目）が登録されます。" },
  { title: "アプリに表示されている案内に沿って同意依頼SMSを送ります。", outcome: "相手にSMS（ショートメッセージ）が届きます。" }
] as const;
...
export const contactConsentNotes = [
  "連絡先A（1人目）と連絡先B（2人目）を登録すると、それぞれの人に同意依頼のSMS（ショートメッセージ）が届きます。",
  "SMSには、あんぴッチからの説明と、同意するためのリンクが入っています。",
  "連絡先の人がリンクを開き、内容を確認して同意すると、アプリ上の表示が「同意済み」になります。",
  "ここでいう同意とは、「この人にSMSを送ってよい」という確認のことです。",
  "登録しただけでは、自動通知は始まりません。",
  "連絡先A（1人目）と連絡先B（2人目）の両方が「同意済み」になるまで、自動通知は始まりません。"
] as const;
...
export const contactStatusStates = [
  {
    label: "同意待ち",
    summary: "まだ返事がありません。",
    detail: "同意依頼のSMSは送られています。相手がまだ同意していない状態です。この状態では、自動通知は始まりません。",
    tone: "warning"
  },
  {
    label: "同意済み",
    summary: "相手が同意しています。",
    detail: "相手が内容を確認し、SMSを受け取ることに同意した状態です。AとBの両方が同意済みになると、準備完了です。",
    tone: "success"
  },
  {
    label: "停止中",
...
export const contactStopNotes = [
  "連絡先がSMSを受け取りたくない場合は、SMSに STOP と返信すると停止できます。",
  "停止中の連絡先には、自動通知のSMSは届きません。",
  "まちがって停止した場合は、START または UNSTOP と返信すると受信を再開できます。",
  "受信を再開したあとも、もう一度Webで同意が必要になる場合があります。"
] as const;
...
export const contactTroubles = [
  ...
  },
  {
    ...
    answers: ["同意してくれない人には、無理に登録しません。", "あんぴッチは、相手の同意があって初めてSMSを送ります。", "別の家族、友人、近所の人など、協力してくれる人を選びます。"]
  },
  {
    question: "電話帳から選べない",
