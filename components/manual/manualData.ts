...
export const keyFacts = [
    ...
    },
    {
        ...
        body: "本人確認が完了すると、連絡先Aと連絡先BのURL同意前でもOKは記録できます。ただし、2人とも同意済みになるまで連絡先への通知は始まりません。",
        tone: "warning",
    },
    {
        title: "あとで見返せます",
...
export const setupReminders = [
    "本人確認が完了すると、連絡先A/BのURL同意前でもOKは記録できます。ただし、2人のURL同意がそろうまで連絡先への通知は始まりません。",
...
export const contactASteps = [
    {
        title: "アプリで「連絡先」画面を開きます。",
        outcome: "連絡先A（1人目）と連絡先B（2人目）の枠が見えます。",
    },
    { title: "連絡先A（1人目）の登録ボタンを押します。", outcome: "入力する画面が開きます。" },
    {
        title: "電話帳から選ぶか、名前と電話番号を手で入力します。",
        outcome: "名前と電話番号が入ります。メールは任意です。",
    },
    {
        title: "名前と電話番号を確認します。",
        outcome: "本人の電話番号ではないことを確認できます。",
    },
    {
        title: "内容に間違いがなければ保存します。",
        outcome: "連絡先A（1人目）が同意待ちとして登録されます。",
    },
    {
        title: "アプリに表示されている案内に沿って同意のお願いSMSを送ります。",
        outcome: "本人のスマホから、同意するためのリンクが入ったSMSを送る場合があります。",
    },
] as const;
...
export const contactBSteps = [
    ...
    {
        title: "連絡先A（1人目）とは別の人か確認します。",
        outcome: "AとBが別々の電話番号になります。",
    },
    {
        title: "内容に間違いがなければ保存します。",
        outcome: "連絡先B（2人目）が同意待ちとして登録されます。",
    },
    {
        title: "アプリに表示されている案内に沿って同意のお願いSMSを送ります。",
        outcome: "本人のスマホから、同意するためのリンクが入ったSMSを送る場合があります。",
...
export const contactConsentNotes = [
    "連絡先A（1人目）と連絡先B（2人目）を登録したあと、アプリの案内に沿って同意のお願いSMSを送ります。",
    "同意のお願いSMSは、本人のスマホから届く場合があります。",
    "SMSには、あんぴッチの説明と、同意するためのリンクが入っています。",
    "このSMSにSTOP、HELP、STARTを返信しても、あんぴッチの受け取り設定は変わりません。",
    ...
    "本人確認が完了していれば、連絡先A/BのURL同意前でもOKは記録できます。ただし、2人ともURLから同意済みになるまで連絡先への通知は始まりません。",
] as const;
...
export const contactStatusStates = [
    {
        label: "同意待ち",
        summary: "まだ返事がありません。",
        detail: "連絡先を登録し、同意のお願いSMSを送ったあと、本人の同意を待っている状態です。この状態では、連絡先への通知は始まりません。",
        tone: "warning",
    },
    {
        label: "同意済み",
...
export const contactTroubles = [
    ...
    },
    {
        ...
        answers: [
            "連絡先A（1人目）と連絡先B（2人目）は、別々の電話番号にします。",
            "1人だけでは、2人の連絡先に知らせる仕組みになりません。",
        ],
    },
    {
        question: "SMSが届かない",
        answers: [
            "電話番号が正しいか確認します。",
            "携帯電話番号になっているか確認します。",
            "相手のスマホでSMSを受け取れるか確認します。",
            "少し時間をおいても届かない場合は、同意のお願いをもう一度送ります。",
            "それでも届かない場合は、別の連絡先を検討します。",
        ],
    },
    {
        question: "連絡先の人が同意してくれない",
        answers: [
            "同意してくれない人には、無理に登録しません。",
            "相手の同意があって初めてSMSを送ります。",
            "別の家族、友人、近所の人など、協力してくれる人を選びます。",
        ],
    },
    {
        question: "電話帳から選べない",
        answers: [
            "電話帳へのアクセスを許可していない可能性があります。",
            "電話帳から選べない場合でも、名前と電話番号を手で入力できます。",
        ],
    },
] as const;
...
export const dailySteps = [
    ...
    {
        title: "ホームの表示を見ます。",
        outcome: "通知前、今の状態、最後のOK、OKから、次の予定が見えます。",
    },
] as const;
...
export const escalationTimeline = [
    ...
    },
    {
        time: "30時間",
        title: "本人 SMS",
        detail: "本人へSMSを送ります。36時間で連絡先AへSMSを送る予定です。連絡先へ通知したくない場合は今OKします。",
        tone: "warning",
    },
    {
        time: "36時間",
        title: "連絡先AへSMS",
        detail: "安否が確認できていないため、連絡先AへSMSを送ります。",
        tone: "critical",
    },
    {
        time: "42時間",
        title: "連絡先BへSMS",
        detail: "安否が確認できていないため、連絡先BへSMSを送ります。",
        tone: "critical",
    },
    {
        time: "48時間以降",
        title: "A+B 最終通知",
        detail: "安否が確認できていないため、連絡先AとBへ最後のSMSを送ります。このアプリだけで、本人の状況や場所が分かることを約束するものではありません。",
        tone: "critical",
    },
] as const;
...
export const billingRows = [
    ...
    },
    {
        ...
        trigger: "36時間通知",
        amount: "連絡先SMS",
        detail: "36時間以上続くと、登録・同意済みの連絡先へ通知します。",
        tone: "critical",
    },
    {
        state: "確認",
...
export const faqs = [
    ...
    },
    {
        ...
        answers: [
            "「連絡先」を開きます。",
            "2人の状態を見ます。",
            "同意待ちの人にはSMSをもう一度送ります。",
        ],
    },
    {
        question: "本人確認SMSが届きません",
        answers: [
            "電話番号が正しいか確認します。",
            "SMSを受け取れる番号か確認します。",
            "少し待ってから、もう一度SMSを送ります。",
        ],
    },
    {
        question: "記録に何も出ません",
...
export const closingPoints = [
    ...
    "アプリを開くだけでは記録されない",
    "本人確認後は連絡先A/BのURL同意前でもOKを記録でき、連絡先への通知は2人のURL同意がそろってから始まる",
    "料金は月額300円です",
