...
export const contactASteps = [
  ...
  { title: "アプリに表示されている案内に沿って同意のお願いSMSを送ります。", outcome: "本人のスマホから、同意するためのリンクが入ったSMSを送る場合があります。" }
] as const;
...
export const contactTroubles = [
  ...
  {
    question: "SMSが届かない",
    answers: ["電話番号が正しいか確認します。", "携帯電話番号になっているか確認します。", "相手のスマホでSMSを受け取れるか確認します。", "少し時間をおいても届かない場合は、同意のお願いをもう一度送ります。", "それでも届かない場合は、別の連絡先を検討します。"]
  },
  {
...
export const faqs = [
  ...
  },
  {
    ...
    answers: ["電話番号が正しいか確認します。", "SMSを受け取れる番号か確認します。", "少し待ってから、もう一度SMSを送ります。"]
  },
  {
    question: "記録に何も出ません",
  ...
  {
    question: "料金が気になります",
    answers: ["料金は月額300円です。", "くわしくは料金ページを見てください。"]
  },
  {
