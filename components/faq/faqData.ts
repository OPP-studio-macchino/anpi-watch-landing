...
export const faqFacts: readonly FAQFact[] = [
  ...
  {
    title: "追加料金なし",
    body: "36時間・42時間・48時間の連絡先通知で追加料金は発生しません。月額料金に含まれます。",
    tone: "info"
  },
  {
    title: "できないこと",
...
export const faqSections: readonly FAQSection[] = [
  ...
  {
    id: "billing",
    title: "月額料金と通知エピソード履歴",
    description: "月額料金の考え方と、連絡先へ通知した回数の見方をまとめています。",
    items: [
      {
        faqId: "faq_when_charged",
        question: "お金がかかるのはいつ？",
        searchKeywords: ["いつ料金", "お金 いつかかる", "料金 発生 条件", "36時間 通知"],
        answerSummary: "今のしくみでは、基本は月額料金だけです。36時間以降の連絡先通知で追加料金は発生しません。",
        answerDetail: [
          "月額料金で使うしくみです。",
          "36時間で連絡先AへSMS送信を試行しても、追加料金は発生しません。",
          "42時間や48時間で連絡が増えても、追加料金は発生しません。",
          "今月、連絡先へ何回通知したかは通知エピソード履歴で見られます。"
        ],
        nextAction: "料金が気になるときは、設定から通知エピソード履歴を開く"
      },
      {
        faqId: "faq_no_extra_charge_after_36h",
        question: "36時間や42時間や48時間で、追加料金は発生しますか？",
        searchKeywords: ["追加料金 ある", "36時間 追加料金", "42時間 48時間 料金", "二重料金"],
        answerSummary: "いいえ。36時間以降の連絡先通知は月額料金に含まれます。",
        answerDetail: [
          "36時間で連絡先AへSMS送信を試行しても、追加料金は発生しません。",
          "42時間で連絡先BへSMS送信を試行しても、追加料金は発生しません。",
          "48時間以上で最後のSMS送信を試行しても、追加料金は発生しません。",
          "通知が起きた記録は、通知エピソード履歴として残ります。"
        ],
        nextAction: "通知エピソード履歴として確認する"
      },
      {
        faqId: "faq_notification_history_view",
        question: "今月、連絡先へ何回通知したかは見られるの？",
        searchKeywords: ["通知回数 見たい", "履歴 どこ", "今月 何回通知", "連絡先通知回数"],
        answerSummary: "はい。今月の連絡先通知回数や、通知エピソード履歴を見返せます。",
        answerDetail: [
          "ホームまたは設定を開きます。",
          "通知エピソード履歴、または連絡先通知回数の画面を開きます。",
          "いつ、だれに、どの通知を送ったかを確認できます。",
          "配信結果も、分かる範囲で表示します。"
        ],
        nextAction: "ホームまたは設定から、通知エピソード履歴の画面を開く"
      }
    ]
  },
  {
