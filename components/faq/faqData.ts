...
export const faqFacts: readonly FAQFact[] = [
  ...
  {
    title: "追加料金なし",
    body: "36時間・42時間・48時間の連絡先通知で追加料金はかかりません。月ごとの料金に含まれます。",
    tone: "info"
  },
  {
    title: "できないこと",
...
export const faqSections: readonly FAQSection[] = [
  ...
  },
  {
    id: "billing",
    title: "料金と通知履歴",
    description: "料金の考え方と、連絡先へ通知した回数の見方をまとめています。",
    items: [
      {
        faqId: "faq_when_charged",
        question: "お金がかかるのはいつ？",
        searchKeywords: ["いつ課金", "お金 いつかかる", "料金 発生 条件", "36時間 課金"],
        answerSummary: "今のしくみでは、基本は月ごとの料金だけです。36時間以降の連絡先通知で追加料金はかかりません。",
        answerDetail: [
          "月ごとの料金で使うしくみです。",
          "36時間で連絡先AへSMSを送っても、追加料金はかかりません。",
          "42時間や48時間で連絡が増えても、その回の追加料金はありません。",
          "今月、連絡先へ何回通知したかは履歴で見られます。"
        ],
        nextAction: "料金が気になるときは、設定から料金や通知履歴の画面を開く"
      },
      {
        faqId: "faq_no_extra_charge_after_36h",
        question: "36時間や42時間や48時間で、追加料金は増えますか？",
        searchKeywords: ["追加料金 ある", "36時間 追加料金", "42時間 48時間 料金", "二重課金"],
        answerSummary: "いいえ。36時間以降の連絡先通知は月ごとの料金に含まれます。",
        answerDetail: [
          "36時間で連絡先AへSMSを送っても、追加料金はかかりません。",
          "42時間で連絡先BへSMSを送っても、追加料金はかかりません。",
          "48時間以上で最後のSMSを送っても、追加料金はかかりません。",
          "通知が起きた記録は、通知履歴として残ります。"
        ],
        nextAction: "追加料金ではなく、通知履歴として確認する"
      },
      {
        faqId: "faq_notification_history_view",
        question: "今月、連絡先へ何回通知したかは見られるの？",
        searchKeywords: ["通知回数 見たい", "履歴 どこ", "今月 何回通知", "連絡先通知回数"],
        answerSummary: "はい。今月の連絡先通知回数や、通知の履歴を見返せます。",
        answerDetail: [
          "ホームまたは設定を開きます。",
